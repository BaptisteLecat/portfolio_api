 ...
 */
final class Version20220413162058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD company_id INT DEFAULT NULL, ADD school_id INT DEFAULT NULL, ADD start DATETIME NOT NULL, ADD end DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project DROP company_id, DROP school_id, DROP start, DROP end');
    }
}
